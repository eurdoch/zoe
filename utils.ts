...
export const getExercisesByNameAndConvertToDataPoint = async (name: string): Promise<{dataPoints: DataPoint[], exerciseEntries: ExerciseEntry[]}> => {
  const exerciseEntries = await getExerciseDataByName(name);
